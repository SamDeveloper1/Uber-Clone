...
const Riding = () => {
  ...
  return (
    <div className='h-screen'>
      <Link to="/home" className='w-10 h-10 fixed bg-white top-2 right-2 flex justify-center items-center rounded-full'><i className="text-lg ri-home-5-line"></i></Link>
      ...
      <div className="flex gap-1 flex-col justify-between items-center -mt-2 ">
        ...
        <div className="w-full mt-3">
          ...
          <div className="flex items-center gap-2 p-3 border-b-2 ">
            ...
            <div>
              <h3 className="text-medium font-medium">Third Wave Coffee</h3>
